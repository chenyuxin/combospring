...
import com.github.chenyuxin.combo.dao.resource.anotation.Column;
import com.github.chenyuxin.combo.dao.resource.anotation.Table;
import com.github.chenyuxin.combo.dao.resource.custom.QueryCondition;
import com.github.chenyuxin.combo.dao.resource.custom.QueryConditionCommonOrder;
...
public class CommonSql {
	 ...
	 * @return
	 */
	public static <T> String selectSql(Class<T> clazz, Map<String, Object> paramMap, QueryCondition... queryConditions) {
		StringBuffer sBuffer = new StringBuffer();
		List<String> objFieldList = CommonSql.getConvertColNames(clazz, "select");
		Table table = clazz.getAnnotation(Table.class);
